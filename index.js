...
const navCerrado = document.querySelector(".cerrado");
...
navCerrado.addEventListener("click", () => {
  if (navLeft < 0) {
    menu.classList.remove("show");
    document.body.classList.remove("show");
    navBar.classList.remove("show");
...
const Temafondo = document.querySelector(".Temafondo");
const control = document.querySelector(".control");

Temafondo.addEventListener("click", () => {
  control.classList.toggle("open");
});

const colores = [...document.querySelectorAll(".colores span")];
document.querySelector(":root").style.setProperty("--customColor", "#000");
...
new TypeIt("#type1", {
  ...
  .type("Desarrollador Web.", { delay: 600 })
  .pause(500)
  .delete(9)
  .go();
...
new TypeIt("#type2", {
  ...
  .type("Desarrollador Front-End.", { delay: 400 })
  .pause(500)
  .delete(9)
  .go();
